                        ...
                        <div class="card-body row">
                            ...
                            <div class="col-md-7">
                                ...
                                <form wire:submit.prevent="editLead">
                                    <div wire:loading wire:target="editLead">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="inputName" class="form-control form-control-sm"
                                            wire:model.defer="name" value="{{ $name }}" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="inputInquiry" class="form-control form-control-sm" rows="5"
                                            wire:model.defer="inquiry">{{ $inquiry }}
                                        </textarea>
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-warning float-right"><i class="fas fa-edit mr-1"></i>
                                            Edit Lead</button>
                                    </div>
                                </form>
                            </div>
